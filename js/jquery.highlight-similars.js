...
Highlighting publications from particular database directly in search output of Google Scholar.
    ...
    function innerHighlight(node, pat, fbgcolor) {
        ...
        if (node.nodeType == 3 && tagType === 'a') {
            ...
            if (paarSimilarity > 0.5){
                ...
                writeToConsoleLog("searchPattern " + searchPattern);
                writeToConsoleLog("dataToCheck " + dataToCheck);
                writeToConsoleLog("similarity: " + paarSimilarity);

                var levensteinDistance = searchPattern.levenstein(dataToCheck);
                writeToConsoleLog("levenstein: " + levensteinDistance);
